...
let s:gb.dark0_hard  = ['#282c34', 234]     " 29-32-33
let s:gb.dark0       = ['#282828', 235]     " 40-40-40
let s:gb.dark0_soft  = ['#32302f', 236]     " 50-48-47
let s:gb.dark1       = ['#31353f', 237]     " 60-56-54
let s:gb.dark2       = ['#393f4a', 239]     " 80-73-69
let s:gb.dark3       = ['#424855', 241]     " 102-92-84
let s:gb.dark4       = ['#4a5260', 243]     " 124-111-100
let s:gb.dark4_256   = ['#4a5260', 243]     " 124-111-100
...
let s:gb.bright_aqua   = ['#b8bb26', 142]     " 184-187-38
let s:gb.bright_yellow  = ['#fabd2f', 214]     " 250-189-47
let s:gb.bright_blue    = ['#83a598', 109]     " 131-165-152
let s:gb.bright_purple  = ['#d3869b', 175]     " 211-134-155
let s:gb.bright_green    = ['#8ec07c', 108]     " 142-192-124
let s:gb.bright_orange  = ['#fe8019', 208]     " 254-128-25

let s:gb.neutral_red    = ['#cc241d', 124]     " 204-36-29
let s:gb.neutral_aqua  = ['#98971a', 106]     " 152-151-26
let s:gb.neutral_yellow = ['#d79921', 172]     " 215-153-33
let s:gb.neutral_blue   = ['#458588', 66]      " 69-133-136
let s:gb.neutral_purple = ['#b16286', 132]     " 177-98-134
let s:gb.neutral_green   = ['#689d6a', 72]      " 104-157-106
let s:gb.neutral_orange = ['#d65d0e', 166]     " 214-93-14

let s:gb.faded_red      = ['#9d0006', 88]      " 157-0-6
let s:gb.faded_aqua    = ['#79740e', 100]     " 121-116-14
let s:gb.faded_yellow   = ['#b57614', 136]     " 181-118-20
let s:gb.faded_blue     = ['#076678', 24]      " 7-102-120
let s:gb.faded_purple   = ['#8f3f71', 96]      " 143-63-113
let s:gb.faded_green     = ['#427b58', 66]      " 66-123-88
...
hi! link markdownH1 GruvboxAquaBold
...
hi! link markdownCode GruvboxGreen
hi! link markdownCodeBlock GruvboxGreen
hi! link markdownCodeDelimiter GruvboxGreen
...
hi! link markdownUrlTitleDelimiter GruvboxAqua
