...
Usage:
  eval "$(scripts/zps-test-env.sh setup)"
      ...
      data dirs) and prints export statements for ZPS_TEST_ROOT,
      ZELLIJ_SOCKET_DIR, ZELLIJ_CONFIG_FILE, and ZPS_ZELLIJ_BIN. eval'ing
      wires them into your current shell.
