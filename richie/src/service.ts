...
.richie-target{display:none;position:absolute;left:100%;top:-7px;margin-left:8px;font-size:.72rem;white-space:nowrap;z-index:3}
...
.md-text-range,.mermaid-source-line{position:relative}
h1,h2,h3,td,tr,details{position:relative}
