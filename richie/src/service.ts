...
.math-target{position:relative;display:inline-block;cursor:pointer;border-radius:4px}.math-display{display:block;overflow:auto;margin:1.2rem 0;padding:12px;background:var(--surface);border:1px solid var(--border)}.math-rendered{display:block}.math-source{position:absolute;inset:0;z-index:1;display:block;overflow:hidden;color:transparent;white-space:pre;cursor:text;user-select:text}.math-source::selection{background:rgba(234,157,52,.45)}.math-source-panel{position:relative;z-index:2;margin:12px -4px -4px;border-top:1px solid var(--border);font:14px/1.6 ui-monospace,SFMono-Regular,Menlo,Consolas,"Liberation Mono",monospace}.math-source-panel summary{padding:6px 8px;color:var(--pine);font-weight:700;cursor:pointer}.math-source-panel pre{margin:0;padding:8px;border:0;box-shadow:none}.math-source-line{display:block;min-height:1.6em;white-space:pre}.math-source-line:hover{background:rgba(215,130,126,.18)}
